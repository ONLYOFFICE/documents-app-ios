...
class ASCConstants {
    ...
    enum FileExtensions {
        static let documents = ["docx", "dotx", "doc", "odt", "rtf", "mht", "html", "htm", "epub", "fb2", "txt", "pages", "hwp", "hwpx", "md", "markdown"]
        static let spreadsheets = ["xlsx", "xls", "xlsb", "xltx", "ots", "csv", "ods", "numbers"]
        static let presentations = ["pptx", "ppsx", "potx", "ppt", "odp", "odg", "otp", "key"]
        ...
        static let allowEdit = ["docx", "dotx", "ots", "otp", "potx", "xlsx", "xltx", "pptx", "ppsx", "csv", "txt", "odt", "ods", "odp", "odg", "doc", "xls", "xlsb", "ppt", "rtf", "mht", "html", "htm", "epub", "fb2", "docxf", "oform", "pages", "numbers", "key", "hwp", "hwpx", "md", "markdown"]
        static let editorImportDocuments = ["doc", "dotx", "odt", "txt", "rtf", "mht", "html", "htm", "epub", "fb2", "pages", "hwp", "hwpx", "md", "markdown"]
        static let editorImportSpreadsheets = ["xls", "xlsb", "ots", "xltx", "ods", "csv", "numbers"]
        static let editorImportPresentations = ["ppt", "ppsx", "potx", "odp", "odg", "otp", "key"]

...
extension ASCDocSpaceFiltersController {
    struct State {
        ...
        private static let docTypeFilters = [
            ...
            ASCDocumentsFilterModel(filterName: FiltersName.pdfDocuments.localizedString(), isSelected: false, filterType: .pdfDocuments),
            ASCDocumentsFilterModel(filterName: FiltersName.pdfForms.localizedString(), isSelected: false, filterType: .pdfForms),

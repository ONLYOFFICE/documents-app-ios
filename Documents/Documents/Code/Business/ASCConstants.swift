...
class ASCConstants {
    ...
    enum FileExtensions {
        static let documents = ["docx", "doc", "odt", "rtf", "mht", "html", "htm", "epub", "fb2", "txt", "pages"]
        ...
        static let allowEdit = ["docx", "xlsx", "pptx", "csv", "txt", "odt", "ods", "odp", "doc", "xls", "ppt", "rtf", "mht", "html", "htm", "epub", "fb2", "docxf", "oform", "pages", "numbers", "key"]
        static let editorImportDocuments = ["doc", "odt", "txt", "rtf", "mht", "html", "htm", "epub", "fb2", "pages"]

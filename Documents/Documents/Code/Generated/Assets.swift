...
internal enum Asset {
  internal enum Colors {
    ...
    internal static let presentationEditor = ColorAsset(name: "presentation-editor")
    internal static let spreadsheetEditor = ColorAsset(name: "spreadsheet-editor")
  ...
  internal enum Images {
    ...
    internal static let barArchive = ImageAsset(name: "bar-archive")
    ...
    internal static let barInfo = ImageAsset(name: "bar-info")
    ...
    internal static let navLink = ImageAsset(name: "nav-link")
    ...
    internal static let categoryFolder = ImageAsset(name: "category-folder")
    ...
    internal static let cloudKdrive = ImageAsset(name: "cloud-kdrive")
    ...
    internal static let createFolder = ImageAsset(name: "create-folder")
    internal static let createIcloud = ImageAsset(name: "create-icloud")
    internal static let createImport = ImageAsset(name: "create-import")
    internal static let createPicture = ImageAsset(name: "create-picture")
    ...
    internal static let listFormatDocumentProtected = ImageAsset(name: "list-format-document-protected")
    ...
    internal static let listFormatPresentationProtected = ImageAsset(name: "list-format-presentation-protected")
    internal static let listFormatPresentation = ImageAsset(name: "list-format-presentation")
    internal static let listFormatSpreadsheetProtected = ImageAsset(name: "list-format-spreadsheet-protected")
    ...
    internal static let menuComment = ImageAsset(name: "menu-comment")
    internal static let menuCustomFilter = ImageAsset(name: "menu-custom-filter")
    internal static let menuDenyAccess = ImageAsset(name: "menu-deny-access")
    internal static let menuDocuments = ImageAsset(name: "menu-documents")
    internal static let menuFiles = ImageAsset(name: "menu-files")
    ...
    internal static let checkmarkGreen = ImageAsset(name: "checkmark-green")
    ...
    internal static let roomFillingForms = ImageAsset(name: "room-filling-forms")
    internal static let roomReview = ImageAsset(name: "room-review")
    internal static let roomViewOnly = ImageAsset(name: "room-view-only")
    ...
    internal static let logoKdriveLarge = ImageAsset(name: "logo-kdrive-large")

...
class ASCCreatePortalViewController: ASCBaseViewController {
    ...
    @IBOutlet var portalField: ParkedTextField!
    @IBOutlet var firstNameField: SkyFloatingLabelTextField!
    @IBOutlet var lastNameField: SkyFloatingLabelTextField!
    @IBOutlet var emailField: SkyFloatingLabelTextField!
    @IBOutlet var passwordOneField: SkyFloatingLabelTextField!
    @IBOutlet var passwordTwoField: SkyFloatingLabelTextField!
    @IBOutlet var countryButton: ASCButtonStyle!

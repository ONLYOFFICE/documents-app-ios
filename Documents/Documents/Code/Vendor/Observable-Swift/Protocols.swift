...
public protocol AnyEvent {
    ...
    @discardableResult
    mutating func add(_ handler: @escaping (ValueType) -> Void) -> EventSubscription<ValueType>
    ...
    @discardableResult
    mutating func add(owner: AnyObject, _ handler: @escaping (ValueType) -> Void) -> EventSubscription<ValueType>
}

...
class ASCSharingAddRightHoldersViewController: UIViewController {
    ...
    var usersModels: [ASCSharingRightHolderViewModel] = [
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Abel – Abe, Abie;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Abner – Ab, Abbie;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Abraham, Abram – Abe, Abie, Bram;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Adam – Ad, Addie, Addy, Ade;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Benjamin – Ben, Bennie, Benny, Benjy Benjie;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Bennet, Bennett – Ben, Bennie, Benny;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Bernard, Barnard – Bernie, Berney, Barney, Barnie", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Christopher Kit, Kester, Kristof, Toph,", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Clarence – Clare, Clair;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Clare, Clair;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Clark, Clarke;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Claude, Claud;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Donald – Don, Donnie, Donny", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Donovan – Don, Donnie, Donny;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Dorian;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Dougls, Douglass – Doug;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Doyle;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Drew (see Andrew);", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Elliot, Elliott – El;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Ellis – El;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Elmer – El;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Elton, Alton – El, Al;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Elvin, Elwin, Elwyn – El, Vin, Vinny, Win;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Elvis – El;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Herman – Manny, Mannie;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Hilary, Hillary – Hill, Hillie, Hilly;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Homer;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Horace, Horatio;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Howard – Howie;", rightHolderType: .user),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Hubert – Hugh, Bert, Bertie", rightHolderType: .user),
    ]
    
    var groupsModels: [ASCSharingRightHolderViewModel] = [
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Admins"),
        ASCSharingRightHolderViewModel(avatarUrl: nil, name: "Disigners")
    ]

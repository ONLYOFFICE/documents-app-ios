...
internal enum Asset {
  internal enum Colors {
    internal static let brendDocuments = ColorAsset(name: "brend-Documents")
  ...
  internal enum Images {
    ...
    internal static let whatsnewFutureComments = ImageAsset(name: "whatsnew-future-comments")
    internal static let whatsnewFutureReview = ImageAsset(name: "whatsnew-future-review")
  }
}

...
public extension String {
    ...
    func addingASCIIEntities() -> String {
        var result = ""
...
public extension String {
    ...
    func removingHTMLEntities() -> String {
        ...
        while let delimiterIndex = self[currentIndex...].firstIndex(of: "&") {
            ...
            var semicolonIndex = index(after: delimiterIndex)
            ...
            while semicolonIndex != endIndex, self[semicolonIndex] != ";" {
                ...
                semicolonIndex = index(after: semicolonIndex)
            }
            ...
            if let unescapedNumber = escapableContent.unescapeAsNumber() {
                ...
                cursorPosition = index(semicolonIndex, offsetBy: 1)
                ...
                cursorPosition = index(after: lastDelimiterIndex)
            }
...
private extension StringProtocol {
    ...
    func unescapeAsNumber() -> String? {
        ...
        let unescapableContent = dropFirst()

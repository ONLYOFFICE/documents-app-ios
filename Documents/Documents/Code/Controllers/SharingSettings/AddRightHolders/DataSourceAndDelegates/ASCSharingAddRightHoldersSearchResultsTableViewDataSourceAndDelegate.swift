...
class ASCSharingAddRightHoldersSearchResultsTableViewDataSourceAndDelegate: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        _ = sourceTableView.delegate?.tableView?(sourceTableView, willSelectRowAt: sourceRowIndexPath)
    ...
    func tableView(_ tableView: UITableView, didDeselectRowAt indexPath: IndexPath) {
        ...
        _ = sourceTableView.delegate?.tableView?(sourceTableView, willDeselectRowAt: sourceRowIndexPath)
